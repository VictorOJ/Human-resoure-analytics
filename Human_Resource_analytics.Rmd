...
set.seed(1337)
model_rf <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome + totalRate + Numcompworked + Yearsatcompany + Yearsincurrentrole +  Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + performancerating, method = "rf", data = smote_trainrem, trControl = trainControl)
...
```{r}
set.seed(1337)
model_svm <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome + totalRate + Numcompworked + Yearsatcompany + Yearsincurrentrole +  Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + performancerating, method = "svmRadial", data = smote_trainrem, trControl = trainControl)
...
```{r}
set.seed(1337)
model_glm <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome + totalRate + Numcompworked + Yearsatcompany + Yearsincurrentrole +  Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + performancerating , method = "glm", data = smote_trainrem, trControl = trainControl, family = binomial(logit))
...
library(xgboost)
set.seed(1337)
model_xgb <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome + totalRate + Numcompworked + Yearsatcompany + Yearsincurrentrole +  Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + performancerating, method = "xgbTree", data = smote_trainrem, trControl = trainControl)
...
```{r}
set.seed(1337)
model_lda <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome + totalRate + Numcompworked + Yearsatcompany + Yearsincurrentrole +  Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + performancerating, method = "lda", data = smote_trainrem, trControl = trainControl)
...
```
```{r}
plot(roc_rf, ylim = c(0,1), print.thres = T, main = "ROC curves", col = "blue")
plot(roc_glm, ylim = c(0,1), print.thres = T, col = "green", add = T)
plot(roc_lda, ylim = c(0,1), print.thres = T,  col = "yellow", add = T)
plot(roc_svm, ylim = c(0,1), print.thres = T,  col = "burlywood", add = T)
plot(roc_xgb, ylim = c(0,1), print.thres = T,  col = "purple", add = T)
