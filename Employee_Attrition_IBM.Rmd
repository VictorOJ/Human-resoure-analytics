...
rf_varimportance <- randomForest(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome +  Numcompworked + Yearsatcompany +  Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + Yearswithoutchange + joblevel , smote_trainrem, importance=TRUE,ntree=500)
...
set.seed(1337)
model_rf <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome + Numcompworked + Yearsatcompany + Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + Yearswithoutchange + joblevel, method = "rf", data = smote_trainrem, trControl = trainControl)
...
```{r}
set.seed(1337)
model_svm <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome + Numcompworked + Yearsatcompany + Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + Yearswithoutchange + joblevel, method = "svmRadial", data = smote_trainrem, trControl = trainControl)
...
```{r}
set.seed(1337)
model_glm <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome +  Numcompworked + Yearsatcompany  + Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + joblevel + Yearswithoutchange , method = "glm", data = smote_trainrem, trControl = trainControl, family = binomial(logit))
...
library(xgboost)
set.seed(1337)
model_xgb <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome +  Numcompworked + Yearsatcompany +  Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + Yearswithoutchange + joblevel, method = "xgbTree", data = smote_trainrem, trControl = trainControl)
...
model_xgb1 <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome +  Numcompworked + Yearsatcompany +  Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + Yearswithoutchange + joblevel, method = "xgbTree", data = smote_trainrem, trControl = fitControl, tuneGrid = xgbGrid)
...
```{r}
set.seed(1337)
model_lda <- train(Attrition ~ Department + Age + Education + MaritalStatus + BusinessTravel + JobRole + DistancefromHome + DailyRate + HourlyRate + MonthlyRate + MonthlyIncome + Numcompworked + Yearsatcompany + Yearssincelastpromotion +  trainingtimeslastyear + stockoptionlevel + salaryhike + educationfield + jobsatisfaction + jobinvolvement + relationshipsatisfaction + worklifebalance + environmentsatisfaction + overtime + AgeGroup + OverallSatisfaction + OverallSatisfactionlevel + jobclass + Incomelevel + Yearswithoutchange + joblevel, method = "lda", data = smote_trainrem, trControl = trainControl)
...
#The most important varaibles are 
Job role
Overtime
Distance from home
Monthly income
...
job_att <-smote_train %>%
  group_by(JobRole)%>%
  summarize(attrition_rate=mean(Attrition=="Yes"))%>%
  ggplot(aes(x=JobRole,y=attrition_rate), fill = 'JobRole') + geom_bar(stat='identity',alpha=0.5,fill='purple') +
  coord_flip()
...
```{r}
ggplot(smote_train, aes(JobRole,fill = Attrition)) + geom_histogram(stat="count") + coord_flip()
```
